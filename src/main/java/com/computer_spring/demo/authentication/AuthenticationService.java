...
import com.computer_spring.demo.config.JwtService;
...
import com.computer_spring.demo.repository.RoleRepository;
import com.computer_spring.demo.repository.UserRepository;
import com.computer_spring.demo.token.Token;
import com.computer_spring.demo.token.TokenRepository;
...
public class AuthenticationService {
	...
	public AuthenticationResponse register(RegisterRequest request) {
		var user = User.builder()
				...
				.roles(Set.of(new Role(RoleType.USER)))
				.build();
